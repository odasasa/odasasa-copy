...
export default function OrderPage({ params }: any) {
    const { data: orders, error } = useFetch(`/api/orders?vendor=${params.vendor}`)
    if (!Array.isArray(orders)) return <div className="flex justify-center items-center m-10"> No orders</div>
    return <>
