  ...
  return (
    ...
    >
      <div className="w-full  flex flex-col   md:w-1/2 gap-5 text-center">
        {/* Title */}
        <Typography variant="h1" className="text-5xl md:text-6xl font-medim mb-2 md:py-6">Organise Orders on WhatsApp</Typography>
        {/* sub title */}
        <Typography variant="p"  className="text-lg md:text-xl font-normal mb-2">
          Without messaging manually. <br />Start receiving orders ready for
          fulfillment.
        </Typography>
      ...
      <div className="w-full md:w-1/2 pt-5">
        <Img src="/vendors/vendor/hero_default_img.png" alt=""
